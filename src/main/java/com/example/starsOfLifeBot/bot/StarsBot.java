...
public class StarsBot implements SpringLongPollingBot, LongPollingSingleThreadUpdateConsumer {
    ...
    public StarsBot(@Value("${tg.api.token}") String token, TelegramClient telegramClient, BotPersonRepa botPersonRepa, BotPrognozRepa botPrognozRepa, IiServise iiServise, BotMessageDispatcher botMessageDispatcher) {
        this.token = token;
